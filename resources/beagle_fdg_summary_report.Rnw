...
civet_scanId_filename_fullpath <-file.path(fdg_subdir_fullPath, "civet_scan_id.txt")
...
#
# read the attenuated cerebellar GM mask --- will be fewer voxels, if cerebellum truncated 
